...
contract FundMeTest is Test {
    ...
    uint256 constant GAST_PRICE = 1;

    function setUp() external {
        //fundMe = new FundMe(0x694AA1769357215DE4FAC081bf1f309aDC325306);
        DeployFundMe deployFundMe = new DeployFundMe();
        fundMe = deployFundMe.run();
        // cheatcode to fake money to a fake account
    ...
    function testFundFailedFailsWithoutEnoughETH() public {
    ...
    function testWithdrawFromMulitpleFunders() public funded {
        ...
        for (uint160 i = startingFunderIndex; i < numberOfFunders; i++) {
            ...
            fundMe.fund{value: SEND_VALUE}(); // fund the FundMe contract
        }
